...
export default function ProductAction({product}:{product:Product}) {
    ...
    return (
        <div className="fiexd bottom-0 left-0 right-0 max-w-6xl mx-auto p-4 bg-white border-t flex flex-col gap-3 z-20">
            {!isSoldOut && (
            ...
            <div className="flex gap-2 h-14">
                <button
                    disabled={true}
                    className="flex-1 border-2 border-gray-200 text-gray-400 rounded-xl font-bold cursor-not-allowed"
                    >
                    공동구매하기
                </button>
                <button
